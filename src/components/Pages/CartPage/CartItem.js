...
import { ListItem, ListItemAvatar, Divider, ListItemText, Typography, IconButton } from '@mui/material';
...
export default function Cart({ data }) {
    return (
        <>
            <ListItem>
                <ListItemAvatar>
                    <img style={{ padding: '20px' }} src='https://mui.com/static/images/grid/complex.jpg' />
                </ListItemAvatar>
